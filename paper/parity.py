...
save_fig(
    fig,
    f"{PAPER_FIGS}/parity/parity-wren-bandgap-mp+wbm-ensemble.pdf",
    width=400,
    height=300,
)
...
save_fig(
    fig,
    f"{PAPER_FIGS}/parity/parity-wren-bandgap-mp+wbm-ensemble_non-metal.pdf",
    width=400,
    height=300,
)
...
save_fig(
    fig,
    f"{PAPER_FIGS}/parity/parity-wren-bandgap-mp+wbm-ensemble_metal.pdf",
    width=400,
    height=300,
)
...
save_fig(
    fig,
    f"{PAPER_FIGS}/parity/parity-wren-mp-diel-elec-ensemble-robust.pdf",
    width=400,
    height=300,
)
...
save_fig(
    fig,
    f"{PAPER_FIGS}/parity/parity-wren-mp-diel-ionic-ensemble-robust.pdf",
    width=400,
    height=300,
)
