...
#let arkheion(
  ...
  // Keywords
  if keywords != none {
    [*_Keywords_* #h(0.3cm)] + if type(keywords) == array { keywords.map(str).join(" · ") } else { keywords }
  }
...
// shared this function in https://github.com/typst/typst/issues/3269#issuecomment-2032612522
